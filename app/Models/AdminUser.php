...
class AdminUser extends Authenticatable implements CanActivateContract, HasMedia
{
    ...
    public function whattodos()
    {
        return $this->belongsToMany('App\Models\WhatToDo');
    }

    public function whattoeats()
    {
        return $this->belongsToMany('App\Models\WhatToEat');
    }

    public function whattosees()
    {
        return $this->belongsToMany('App\Models\WhatToSee');
    }
