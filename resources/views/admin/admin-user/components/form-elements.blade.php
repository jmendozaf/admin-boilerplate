...
<div class="form-group row align-items-center" :class="{'has-danger': errors.has('whattodos'), 'has-success': fields.whattodos && fields.whattodos.valid }">
    <label for="to" class="col-form-label text-md-right" :class="isFormLocalized ? 'col-md-4' : 'col-md-2'">{{ trans('admin.what-to-do.columns.whattodos') }}</label>
    <div :class="isFormLocalized ? 'col-md-4' : 'col-md-9 col-xl-8'">
        <multiselect
            v-model="form.whattodos"
            placeholder="{{ trans('brackets/admin-ui::admin.forms.select_options') }}"
            label="name"
            track-by="id"
            :options="{{ $WhatToDos->toJson() }}"
            :multiple="true"
            open-direction="bottom">
        </multiselect>
    </div>
...
<div class="form-group row align-items-center" :class="{'has-danger': errors.has('whattoeats'), 'has-success': fields.whattoeats && fields.whattoeats.valid }">
    <label for="to" class="col-form-label text-md-right" :class="isFormLocalized ? 'col-md-4' : 'col-md-2'">{{ trans('admin.what-to-do.columns.whattoeats') }}</label>
    <div :class="isFormLocalized ? 'col-md-4' : 'col-md-9 col-xl-8'">
        <multiselect
            v-model="form.whattoeats"
            placeholder="{{ trans('brackets/admin-ui::admin.forms.select_options') }}"
            label="name"
            track-by="id"
            :options="{{ $WhatToEats->toJson() }}"
            :multiple="true"
            open-direction="bottom">
        </multiselect>
    </div>
...
<div class="form-group row align-items-center" :class="{'has-danger': errors.has('whattosees'), 'has-success': fields.whattosees && fields.whattosees.valid }">
    <label for="to" class="col-form-label text-md-right" :class="isFormLocalized ? 'col-md-4' : 'col-md-2'">{{ trans('admin.what-to-do.columns.whattosees') }}</label>
    <div :class="isFormLocalized ? 'col-md-4' : 'col-md-9 col-xl-8'">
        <multiselect
            v-model="form.whattosees"
            placeholder="{{ trans('brackets/admin-ui::admin.forms.select_options') }}"
            label="title"
            track-by="id"
            :options="{{ $WhatToSees->toJson() }}"
            :multiple="true"
            open-direction="bottom">
        </multiselect>
    </div>
